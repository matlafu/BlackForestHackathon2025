...
/*
  Next.js API route for energy data (dashboard/app/api/energy/route.ts)
  - Proxies requests to the backend Express server at localhost:3001
  - Handles timeouts and backend errors with user-friendly messages
  - Used by the dashboard frontend to fetch energy data
*/
